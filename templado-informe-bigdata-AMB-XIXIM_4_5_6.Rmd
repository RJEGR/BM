...
plot <- plot + coord_flip() + theme(axis.text.x = element_text(angle = 45, hjust = 1, vjust = 1), axis.text.y = element_text(size  = 4)) + facet_grid(Corrida ~ ., space = "free", scales = "free")
...
png(paste0(path,"/", "Figura-10-bubbleplot.Sp.png"), units="px", 
